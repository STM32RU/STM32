...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/stm32/js/groupBy-62b30ac391.min.js');loadScript('/stm32/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/stm32/en.search-data.min.json"
